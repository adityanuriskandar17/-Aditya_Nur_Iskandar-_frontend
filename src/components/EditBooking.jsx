...
const EditBooking = () => {
    ...
    const getBookingById = async (id) => {
        try{
            ...
            setRoomCapacity(booking.roomCapacity.toString())
            setMeetingDate(booking.meetingDate)
            setStartTime(booking.startTime.substring(0, 5))
            setEndTime(booking.endTime.substring(0, 5))
            setParticipantCount(booking.participantCount.toString())
            setConsumptionType(booking.consumptionType)
            setConsumptionAmount(booking.consumptionAmount.toString())
        }catch(error){
            console.error('Error Message: ', error.message)
    ...
    <div style={{ 
        ...
        <div style={{
            ...
            <div style={{ 
                ...
                <span>›</span>
                <span style={{ color: '#374151', fontWeight: '500' }}>Edit Ruangan</span>
            </div>
